---
name: html-ppt
description: "Generate interactive HTML presentations with themes, layouts, animations, and keyboard navigation. Use when user says: 做PPT、做簡報、slides、presentation、deck、keynote、幻燈片、投影片、演講稿、分享稿、小红书图文、pitch deck、reveal.js。"
---
