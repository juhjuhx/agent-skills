---
name: debugging-code
description: "Interactive debugger — breakpoints, step-through, variable inspection, call stack. Use when: 斷點、stack trace、crash、exception、wrong output、interactive debug、runtime inspection、調試器、逐行執行。"
