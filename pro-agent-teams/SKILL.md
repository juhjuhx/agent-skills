---
name: agent-teams
description: "Coordinate multiple Claude Code sessions as a team with shared tasks and messaging. Use when: 代理團隊、agent teams、multiple sessions、team coding、shared task list、coordinate agents、多agent協作。"
---
