...
description: "Generate professional slide deck images from content. Use when: 幻燈片、slide deck、做投影片、create slides、generate deck、PPT圖片、make a presentation、slide images、投影片圖像。"
version: 1.57.0
metadata:
  openclaw:
