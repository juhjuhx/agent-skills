---
name: orchestrate
description: "Wire Commands, Agents, and Skills together for complex multi-phase features. Use when: 編排、orchestration、complex feature、multi-phase development、research-then-implement、coordinate skills、大型功能。"
---
