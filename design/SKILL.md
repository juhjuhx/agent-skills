---
name: ckm:design
description: "Unified design skill: brand, design tokens, UI, logo (55 styles), CIP (50 deliverables), slides, banners (22 styles), icons (15 styles), social photos. Use when: 設計、design、logo設計、banner、簡報、品牌識別、design system、icon design、social media images。"
