---
name: baoyu-imagine
description: "AI image generation via OpenAI, Google, DashScope, MiniMax, Replicate APIs. Use when: 圖像生成、AI圖片、generate image、text-to-image、draw image、做圖、生成圖片、create picture、image generation。"
version: 1.58.0
metadata:
  openclaw:
