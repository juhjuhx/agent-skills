...
description: "Seedance video prompt director — composes production-ready cinematic prompts from reference images or scene descriptions. Use when: Seedance、影片prompt、cinematic scene、影片場景、shot list、music video、action sequence、fashion film、做影片。"
---
