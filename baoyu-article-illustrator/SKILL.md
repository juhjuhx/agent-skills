...
description: "Analyze articles and generate matching illustrations with Type/Style/Palette consistency. Use when: 文章插圖、配圖、illustrate article、add images to article、為文章配圖、generate article images。"
version: 1.59.0
metadata:
  openclaw:
