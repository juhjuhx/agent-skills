...
description: |
  Comprehensive code review for React, Vue, Angular, Svelte, Rust, TypeScript, Python, Go, Java, C#. Catches bugs, improves quality, gives constructive feedback. Use when: code review、代碼審查、PR review、review code、pull request、code quality、找bug。
allowed-tools:
  - Read
  - Grep
  - Glob
