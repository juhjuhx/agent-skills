...
description: "Three.js shaders: GLSL, ShaderMaterial, uniforms, custom effects. Use when: 著色器、GLSL、shader、custom visual effects、fragment shader、vertex shader、ShaderMaterial、自訂材質。"
---
