...
description: "Audit and fix HTML accessibility: ARIA labels, keyboard nav, focus management, color contrast. Use when: 無障礙、WCAG、accessibility、a11y、ARIA、keyboard navigation、color contrast、screen reader。"
---
