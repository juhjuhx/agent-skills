...
description: "Translate articles/documents with three modes (quick/normal/refined) and custom glossaries. Use when: 翻譯、translate、中英翻譯、精翻、快速翻譯、改成中文、改成英文、localize、本地化、proofread translation。"
version: 1.59.0
metadata:
  openclaw:
