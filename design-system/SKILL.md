...
description: "Three-layer design token architecture (primitive/semantic/component), CSS variables, typography scales, component specs. Use when: 設計系統、design tokens、component library、CSS variables、品牌設計系統、systematic design。"
