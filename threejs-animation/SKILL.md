...
description: "Three.js animation: keyframe, skeletal, morph targets, animation mixing. Use when: 3D動畫、Three.js動畫、animate objects、GLTF animation、procedural motion、blend animations、keyframe animation。"
---
