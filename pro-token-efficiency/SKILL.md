...
description: "Reduce token waste 40-60% via anti-sycophancy, tool-call budgets, one-pass coding. Use when: token效率、token efficiency、save tokens、reduce cost、verbose output、too many tokens、節省token。"
---
