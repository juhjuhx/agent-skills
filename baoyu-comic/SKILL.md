---
name: baoyu-comic
description: "Create educational and knowledge comics with multiple art styles. Use when: 漫畫、連環畫、comic strip、知識漫畫、biography comic、tutorial comic、做漫畫、educational comic、Logicomix。"
version: 1.57.0
metadata:
  openclaw:
