...
name: logic-review
description: >
  Find logic bugs in a single file via execution tracing. Use when: 邏輯審查、logic bug、"review this"、"does this look right"、race condition、tests pass but prod fails、code audit、檢查代碼。One file/function only.
---
