...
description: "Create git worktrees for parallel coding sessions with zero dead time. Use when: 並行工作樹、git worktree、parallel branches、context switching、work on multiple branches、waiting on tests、zero dead time。"
---
