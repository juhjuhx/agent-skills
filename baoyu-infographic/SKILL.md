...
description: "Generate infographics with 21 layouts and 22 visual styles. Use when: 信息圖、infographic、數據視覺化、visual summary、高密度信息大圖、data visualization、visualize data、做信息圖。"
version: 1.58.0
metadata:
  openclaw:
