...
description: "Master context engineering — Write, Select, Compress, Isolate operations for AI sessions. Use when: 上下文工程、context engineering、token budget、compaction、context management、session optimization。"
---
