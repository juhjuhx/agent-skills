...
description: "Audit and fix animation performance: layout thrashing, compositor properties, scroll jank. Use when: 動畫效能、animation performance、jank、stutter、animation lag、60fps、smooth animation、scroll performance。"
---
