...
description: "Three.js scene setup: cameras, renderer, Object3D hierarchy, coordinate systems, transforms. Use when: 3D場景、Three.js基礎、setup 3D scene、camera、renderer、Object3D、scene graph、3D scene。"
---
