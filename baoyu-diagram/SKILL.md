---
name: baoyu-diagram
description: "Generate professional dark-themed SVG diagrams — architecture, flowchart, sequence, mind map, timeline. Use when: 畫圖、架構圖、流程圖、SVG diagram、flowchart、sequence diagram、mind map、visualize、畫個圖、network topology、state machine。"
---
